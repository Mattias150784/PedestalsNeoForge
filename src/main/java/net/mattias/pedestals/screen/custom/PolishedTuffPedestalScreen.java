...
public class PolishedTuffPedestalScreen extends AbstractContainerScreen<PolishedTuffPedestalMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Pedestals.MOD_ID, "textures/gui/pedestal/pedestal_gui.png");
    public PolishedTuffPedestalScreen(PolishedTuffPedestalMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
