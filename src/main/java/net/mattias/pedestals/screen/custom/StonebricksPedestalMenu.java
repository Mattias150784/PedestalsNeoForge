...
public class StonebricksPedestalMenu extends AbstractContainerMenu {
    public final StonebricksPedestalBlockEntity blockEntity;
    private final Level level;

    public StonebricksPedestalMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public StonebricksPedestalMenu(int pContainerId, Inventory inv, BlockEntity blockEntity) {
        super(ModMenuTypes.STONE_BRICKS_PEDESTAL_MENU.get(), pContainerId);
        this.blockEntity = ((StonebricksPedestalBlockEntity) blockEntity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.STONE_BRICKS_PEDESTAL.get());
    }
