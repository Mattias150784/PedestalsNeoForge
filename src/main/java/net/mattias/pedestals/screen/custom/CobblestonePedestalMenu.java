...
public class CobblestonePedestalMenu extends AbstractContainerMenu {
    public final CobblestonePedestalBlockEntity blockEntity;
    private final Level level;

    public CobblestonePedestalMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public CobblestonePedestalMenu(int pContainerId, Inventory inv, BlockEntity blockEntity) {
        super(ModMenuTypes.COBBLESTONE_PEDESTAL_MENU.get(), pContainerId);
        this.blockEntity = ((CobblestonePedestalBlockEntity) blockEntity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.COBBLESTONE_PEDESTAL.get());
    }
