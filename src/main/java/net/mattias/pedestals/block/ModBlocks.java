...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> END_STONE_BRICKS_PEDESTAL = registerBlock("end_stone_bricks_pedestal",
            () -> new EndStoneBricksPedestalBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.END_STONE_BRICKS)));

    public static final DeferredBlock<Block> END_STONE_PEDESTAL = registerBlock("end_stone_pedestal",
            () -> new EndStonePedestalBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.END_STONE)));

    public static final DeferredBlock<Block> PURPUR_BLOCK_PEDESTAL = registerBlock("purpur_block_pedestal",
            () -> new PurpurBlockPedestalBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.PURPUR_BLOCK)));

    public static final DeferredBlock<Block> PURPUR_PILLAR_PEDESTAL = registerBlock("purpur_pillar_pedestal",
